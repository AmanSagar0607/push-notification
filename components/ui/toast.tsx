  ...
  return (
    <ToastPrimitives.Root
      ...
      className={cn(
        ...
        'sm:p-6 sm:pr-8', // Larger padding for larger screens
        'p-4 pr-8', // Smaller padding for small screens
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ...
    {...props}
  >
    <X className="h-4 w-4 sm:h-5 sm:w-5" /> {/* Larger icon for larger screens */}
  </ToastPrimitives.Close>
));
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title
    ref={ref}
    className={cn('text-sm font-semibold sm:text-base', className)} // Larger font size for larger screens
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description
    ref={ref}
    className={cn('text-sm opacity-90 sm:text-base', className)} // Larger font size for larger screens
    {...props}
  />
));
